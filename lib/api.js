...
module.exports = {
    ...
    dataset: function(code, options, fn){
        ...
        var qs = options;
        qs.auth_token = this.config.auth_token;

        var config = {
            uri: ["api", this.config.api_version, "datasets", code.source, code.table].join("/"),
            format: format,
            qs: qs
        }
    ...
    multiset: function(codes, options, fn){
        ...
        var config = {
            uri: ["api", this.config.api_version, "multisets"].join("/"),
            format: format,
            qs: qs
        }
    ...
    favorites: function(options, fn){
        ...
        var config = {
            uri: ["api", this.config.api_version, "current_user", "collections", "datasets", "favourites"].join("/"),
            format: format,
            qs: qs
        }
    ...
    search: function(terms, options, fn){
        ...
        var config = {
            uri: ["api", this.config.api_version, "datasets"].join("/"),
            format: format,
            qs: qs
        }
